...
while True:
    ...
    for barcode in decode(img2):
        ...
        sql = "SELECT price FROM  product  WHERE product = '" + myData + "'"
        ...
        if myResult == None:
            ...
            sql1 = "SELECT name FROM product WHERE product = '" + myData + "'"
            myCursor.execute(sql1)
            myResult1 = myCursor.fetchone()
            #colone de tableau
            #EE name and E price
            EE = myResult1[0] #non de produit
            E = myResult[0] #prix
            a = int(E) # str to int
            #cordonneés d'image
            ...
            if pts22 < 250:
                ...
                mydb.commit()
                sql33 = "DELETE  FROM "+pp+" WHERE produit = '" + EE + "'"
